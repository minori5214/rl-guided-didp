...
result_root=rl_agent/hybrid_cp_rl_solver/trained-models/ppo/portfolio/n-item-$n_item/capacity_ratio-$capacity_ratio/lambdas-$lambda_1-$lambda_2-$lambda_3-$lambda_4/seed-$seed/$network_arch
...
python rl_agent/hybrid_cp_rl_solver/problem/portfolio/main_training_ppo_portfolio.py \
    --seed $seed  \
    --n_item $n_item  \
