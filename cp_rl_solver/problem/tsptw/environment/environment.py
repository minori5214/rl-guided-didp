from cp_rl_solver.problem.tsptw.environment.tsptw import *
from cp_rl_solver.problem.tsptw.environment.state import *
...
class Environment:
    ...
    def __init__(self, instance, n_node_feat, n_edge_feat, reward_scaling, grid_size, max_tw_value):
        """
        ...
        self.max_tw_value = max_tw_value
    ...
    def make_nn_input(self, cur_state, mode):
        ...
        node_feat = [[self.instance.x_coord[i] / self.grid_size,  # x-coord
                      ...
                      1 if i == cur_state.last_visited else 0,
                      #cur_state.cur_time, # 1 if it is the last node visited
                      ]
