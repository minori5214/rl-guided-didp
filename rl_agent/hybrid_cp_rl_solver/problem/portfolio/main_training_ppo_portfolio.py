...
from rl_agent.hybrid_cp_rl_solver.problem.portfolio.learning.trainer_ppo import TrainerPPO
...
def parse_arguments():
    ...
    parser.add_argument('--model', default='cappart', help='cappart/narita')
