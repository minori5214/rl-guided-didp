from rl_agent.hybrid_cp_rl_solver.problem.portfolio.environment.portfolio import *
from rl_agent.hybrid_cp_rl_solver.problem.portfolio.environment.state import *
...
class Environment:
    ...
    def get_valid_actions(self, cur_state):
        ...
        available = np.zeros(action_size, dtype=np.int64)
