from rl_agent.hybrid_cp_rl_solver.problem.tsp.environment.tsp import *
from rl_agent.hybrid_cp_rl_solver.problem.tsp.environment.state import *
...
class Environment:
    ...
    def __init__(self, instance, n_node_feat, n_edge_feat, reward_scaling, grid_size):
        """
