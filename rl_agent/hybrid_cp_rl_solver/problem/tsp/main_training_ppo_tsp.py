...
from rl_agent.hybrid_cp_rl_solver.problem.tsp.learning.trainer_ppo import TrainerPPO
...
def parse_arguments():
    ...
    parser.add_argument('--max_tw_gap', type=int, default=100)
    parser.add_argument('--max_tw_size', type=int, default=1000)
