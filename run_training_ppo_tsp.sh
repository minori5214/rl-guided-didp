...
entropy_value=0.001
eps_clip=0.1
batch_size=256 # batch size must be a divisor of update_timestep
latent_dim=128
hidden_layer=4
...
result_root=rl_agent/hybrid_cp_rl_solver/trained-models/ppo/tsp/n$n_city/grid-$grid_size/seed-$seed/$network_arch
...
python rl_agent/hybrid_cp_rl_solver/problem/tsp/main_training_ppo_tsp.py \
    --seed $seed  \
    --n_city $n_city  \
    --grid_size $grid_size \
    --k_epochs $k_epochs \
