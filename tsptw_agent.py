...
import dgl
from cp_rl_solver.problem.tsptw.environment.tsptw import TSPTW
from cp_rl_solver.architecture.graph_attention_network import GATNetwork
from cp_rl_solver.problem.tsptw.learning.actor_critic import ActorCritic
...
class TSPTWAgent(object):
    ...
    def __init__(self, load_folder, instance_path, n_city, grid_size, 
        ...
        n_city, travel_time, x_coord, y_coord, time_windows = read_tsptw.read_rl(instance_path)
