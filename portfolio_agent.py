...
from cp_rl_solver.problem.portfolio.environment.portfolio import Portfolio
from cp_rl_solver.problem.portfolio.learning.actor_critic import ActorCritic
...
class PortfolioAgent(object):
    ...
    def __init__(self, load_folder, instance_path, n_item, capacity_ratio,
        ...
        n_item, capacity, weights, means, deviations, skewnesses, kurtosis, moment_factors = read_portfolio.read(instance_path)
