...
import dgl
from cp_rl_solver.problem.tsp.environment.tsp import TSP
from cp_rl_solver.architecture.graph_attention_network import GATNetwork
from cp_rl_solver.problem.tsp.learning.actor_critic import ActorCritic
...
class TSPAgent(object):
    ...
    def __init__(self, load_folder, instance_path, n_city, grid_size, 
        ...
        n_city, travel_time, x_coord, y_coord = read_tsp.read_rl(instance_path)
        self.instance = TSP(n_city, travel_time, x_coord, y_coord)
