...
result_root=rl_agent/hybrid_cp_rl_solver/trained-models/dqn/tsptw/n-city-$n_city/grid-$grid_size-tw-$max_tw_gap-$max_tw_size/seed-$seed/$network_arch
...
python rl_agent/hybrid_cp_rl_solver/problem/tsptw/main_training_dqn_tsptw.py \
    --seed $seed  \
    --n_city $n_city  \
    --grid_size $grid_size \
